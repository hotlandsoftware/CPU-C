/* 
 * Most code written by CodeSnatcher.
 * Some code has been modified by Hotlands Software.
 * Source: http://www.codescratcher.com/windows-forms/get-computer-hardware-information-using-c/
 */
...
public static class HardwareInfo
{
    ...
    /// <summary>
    /// Retrieving Motherboard Version.
    /// </summary>
    /// <returns></returns>
    ...
    /// </summary>
    /// <returns></returns>
    public static string GetBIOSstatus()
    {
    ...
    /// <summary>
    /// Gets the BIOS Major and Minor Version
    /// </summary>
    /// <returns></returns>
    public static string GetBIOSMajorMinversion()
    {
        ...
        foreach (ManagementObject wmi in searcher.Get())
        {
            try
            {
                return wmi.GetPropertyValue("SMBIOSMajorVersion").ToString() + "." + wmi.GetPropertyValue("SMBIOSMinorVersion").ToString();
    ...
    public static int GetCPUMaxClockSpeed()
    {
        int cpuMaxClockSpeed = 0;
        //create an instance of the Managemnet class with the
        //Win32_Processor class
        ManagementClass mgmt = new ManagementClass("Win32_Processor");
        //create a ManagementObjectCollection to loop through
        ...
        foreach (ManagementObject obj in objCol)
        {
            ...
            {
                // only return cpuStatus from first CPU
                cpuMaxClockSpeed = Convert.ToInt32(obj.Properties["MaxClockSpeed"].Value.ToString());
            }
        }
        //return the status
    ...
    /// <summary>
    /// Retrieving Physical Number of Processors.
    /// </summary>
    /// <returns></returns>
    /* TODO: Detect processors excluded from Windows through setupapi.dll */
    public static string GetCPUPhysProcessorCount()
    {
        ...
        foreach (ManagementObject wmi in searcher.Get())
        {
            try
            {
                ...
                return wmi.GetPropertyValue("NumberOfProcessors").ToString();
            }
            catch { }
        }
        return "Unknown";
